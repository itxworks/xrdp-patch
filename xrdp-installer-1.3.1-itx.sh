...
cat << EOF > /etc/apt/sources.list.d/source-package-repositories.list
#deb-src http://packages.linuxmint.com una main upstream import backport #id:linuxmint_main
